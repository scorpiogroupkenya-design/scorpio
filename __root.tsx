  ...
  head: () => ({
    meta: [
      ...
      { title: "Scorpio Group — Security Holdings | Across Africa" },
      {
        name: "description",
        content:
          "Scorpio Group is the holding company behind Scorpio Security Services — elite manned guarding, VIP protection, and risk management across the African continent.",
      },
      { name: "author", content: "Scorpio Group" },
